...
class Hitbox extends FlxSpriteGroup
{
	...
	public function new(?widghtScreen:Int)
	{
		...
		var hitbox_hint:FlxSprite = new FlxSprite(0, 0).loadGraphic('android/hitbox/hitbox_hint.png');
	...
	public function createhitbox(X:Float, framestring:String) {
		...
		var frames = FlxAtlasFrames.fromSparrow('android/hitbox/hitbox.png', 'android/hitbox/hitbox.xml');
